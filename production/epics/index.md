...
| 7 | 戏剧引擎 B | `drama-engine` | Feature | **In Stories（推进中）** | GDD ✅`design/gdd/drama-system.md`；核心引擎 drama-003/004/005/006 已落（VariedSelector/值类型/GrudgeLedger/LimitsConfig+WeightedPicker，926 绿）；drama-007~013 待续 |
