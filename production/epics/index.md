...
> 机器可读状态在 `production/sprint-status.yaml`；本表为人读总览。WIP(In Progress)≤2，当前=**0**（全 epic Done 或 deferred）。
...
| 2 | 真·全量机制结构化 | `combat-fullstruct` | Core | **Done** | 7/8 story Complete（2026-07-14 审计；001~007 代码+测试就位，008 Backlog） |
