...
| 7 | 戏剧引擎 B | `drama-engine` | Feature | **In Stories（推进中）** | GDD ✅`design/gdd/drama-system.md`；核心引擎 drama-003~009 已落（原语/账本/状态机/点火/事件+Chronicle/DramaScheduler+IDramaMutator，997 绿）；drama-009b~013 待续 |
