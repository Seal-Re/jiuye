...
| 7 | 戏剧引擎 B | `drama-engine` | Feature | **In Stories（推进中）** | GDD ✅`design/gdd/drama-system.md`；核心引擎 drama-003~008 已落（原语/账本/状态机/点火扫描/6 DomainEvent+Chronicle，990 绿；008 首触 v1.0 文件 off 逐字节实证）；drama-009~013 待续 |
