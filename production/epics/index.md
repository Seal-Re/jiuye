...
| 7 | 戏剧引擎 B | `drama-engine` | Feature | **In Stories（推进中）** | GDD ✅`design/gdd/drama-system.md`；核心引擎 drama-003~009b 已落（原语/账本/状态机/点火/事件/调度器/DramaDirector.Pump 编排，1008 绿）；仅剩 World 接线 drama-010（⚠️最高危）+ 011~013 |
