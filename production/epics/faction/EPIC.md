...
**Layer**: Feature
**Status**: C.0 Done（接线/membership/生命周期/晋升/夺地全实现；C.1 朝廷/经营远期）
...
| 011 | C.0 非致死夺地兑现世仇 | ✅ Done | design §3；territory+relation 联动，Might World 注入，只扫边界（INV-PERF）|
...
- [x] 贡献驱动晋升（story-010）
- [x] 非致死夺地世仇（story-011）
- [x] 被动兴衰 Pump（story-008 已接，C.0 完整待 010/011）
