        ...
        private static CultivationPathDef Build()
        {
            ...
            var skills = new[]
            {
                ...
                new CombatSkillDef("sk_sw_poyujian", "破·御剑诀", 3,
                    new[] { new EffectOp(EffectOpKind.AddPenInteger, null, 24, "无视阻挡与距离直取敌方最高power者,必中") },
                ...
                new CombatSkillDef("sk_sw_yuqiang", "遇强破式", 3,
                    new[] { new EffectOp(EffectOpKind.AddPenInteger, null, 8, "对方power每高出本人10点,本人下一击伤害+8(上限+48)") },
