...
**追溯：** 任务回引设计规格 `docs/legacy-specs/specs/2026-06-13-武侠人设生成-江湖涌现模拟内核-design.md` 的需求 ID（§17）：R-F1..F7 / R-NF1..F7。
...
在 spec `§16 评审溯源` 后追加一行：`v1.0 实现见 docs/legacy-specs/plans/2026-06-13-江湖模拟内核-v1.0.md；R-ID 全覆盖。`（R-NF5 LLM 健壮性、R-F3 关系传播深化属 v1.1。）
...
**Plan complete and saved to `docs/legacy-specs/plans/2026-06-13-江湖模拟内核-v1.0.md`. Two execution options:**
